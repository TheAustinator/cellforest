from cellforest.utils.shell.shell_command import process_shell_command, plot_shell_command, shell_command
...
def run_plot_r_script(branch: "CellBranch", r_script_filepath: str, arg_list: list, process_name: str):
    """
    Runs an R script for a process, which additionally entails outputting log
    files
    """
