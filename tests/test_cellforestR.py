...
def test_cellforest_load_last_process(root_path, norm_reduce_spec, processes_of_norm_reduce_spec, test_norm_reduce):
    branch = test_norm_reduce
...
def test_cellforest_load_all_processes(root_path, norm_reduce_spec, processes_of_norm_reduce_spec, test_norm_reduce):
    branch = test_norm_reduce
    path_to_cellforestR_script = Path(__file__).parent / "r" / "cellforest_load.R"
    # TODO: Add support for passing spec through Rscript
