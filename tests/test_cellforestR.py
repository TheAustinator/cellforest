...
def test_cellforest_load_last_process(root_path_example, norm_reduce_spec, processes_of_norm_reduce_spec):
...
def test_cellforest_load_all_processes(root_path_example, norm_reduce_spec, processes_of_norm_reduce_spec):
    path_to_cellforestR_script = Path(__file__).parent / "r" / "cellforest_load.R"
    # TODO: Add support for passing spec through Rscript
